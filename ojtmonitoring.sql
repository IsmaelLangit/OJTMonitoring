...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2017 at 05:11 AM
...
(4, 'NOKIA Manila Technology Center', 'Building 1 UP Ayala Land TechnoHub, Commonwealth Avenue Barangay UP Campus, Diliman, Quezon City 1101', 'Joanne Faye S. Caparas', 'Recruitment & University Relations Specialist', 'Company-based'),
...
(6, 'ITCert Training Solutions', 'G/F SAJJ Building, Rimando Road, Baguio City', 'Lou Philip Beltran', 'CEO', 'Company-based'),
...
(8, 'MOOG Control Corporation', 'Loakan Road, Baguio City', 'Rayah Sarile', 'HR Head', 'Company-based'),
...
(11, 'Coca-Cola FEMSA Bottlers Philippines Inc.', 'Bued, Calasiao, Pangasinan', 'Michael D. Fabroa', 'HR Executive', 'Company-based'),
...
(16, 'Baguio City Hall - Office of the City Councilor', 'City Hall, City Hall Drive, Baguio City', 'Leandro B. Yangot Jr.', 'City Councilor', 'Company-based'),
...
(21, 'Department of Interior and Local Government - CAR', '125 North Drive, Baguio City, Benguet', 'Engr. Marlo L. Iringan', 'Regional Director, DILG CAR', 'Company-based'),
...
(27, 'Saint Louis University - SCIS Dean\'s Office', '3rd Floor Diego Silang Building, Saint Louis University', 'Dr. Cecillia A. Mercado', 'School Dean', 'In-house'),
(28, 'PhilHealth Inc.', 'Leonard Wood, Baguio City', 'Atty. Jerry F. Ibay', 'Resional Vice President', 'Company-based'),
(29, 'Philippine Scandinavian IT Solutions', '339 G A Yupangco Bldg. Sen. Gil Puyat, Makati City', 'Rachel Christensen', 'Director', 'Company-based'),
...
(32, 'Syner G Outsourcing Inc.', '#2 Lower Ground Floor, Roman Ayson Road, Cresencia Village, Baguio City', 'Joseph Opis Alisisto', 'Section Head', 'Company-based'),
...
(34, 'Pru Life UK - Magnetite 2 Branch', '3/F DBP Building, Lower Session Road, Baguio City', 'Myrna Lazo Solimen', 'Branch Manager', 'Company-based'),
(35, 'ICT Department - DepEd Division Ofice', '#82 Military Cut-off Road, Baguio City, Benguet', 'Harris G. Dizon', 'IT Department Head and Officer', 'Company-based'),
(36, 'Department of Environment and Natural Resources - CAR', 'DENR Compound, Pacdal, Baguio City', 'Engr. Ralph C. Pablo', 'Regional Director ', 'Company-based'),
(37, 'Convergys', 'Ayalaland Technohub, John Hay Special Economic Zone', 'Ma. Faye Castillo', 'Recruitment Manager', 'Company-based'),
(38, 'Virtuosearch Inc.', '#3 Josefa Llanes Escoda St. First Road, Quezon Hill, Baguio City', 'Melanie Racela', 'Supervisor/Head of Research', 'Company-based'),
...
(42, 'Trend Micro', '8th Floor Tower 2, The Rockwell Buisiness Center, Ortigas Avenue, Pasig City, 1600', 'Joanna Aguinaldo', 'HR Manager', 'Company-based'),
...
(47, 'AKTUS Global Management Inc.', 'Unit 2005 C, 20/F West Tower, PSC, Tektite Bldg, Ortigas, Pasig City', 'Esteven D. Fulgar', 'POT Head', 'Company-based'),
...
(51, 'IT/CS Department - School of Computing and Information Sciences', '3rd Floor Diego Silang Building, Saint Louis University', 'Ma. Concepcion Clemente', 'Department Head', 'In-house'),
(52, 'Information and Communications Technology Research Laboratory', '3rd Floor  Diego Silang Building, Saint Louis University', 'Carlos Ben Montes', 'Officer-in-Charge', 'In-house'),
...
(54, 'Accent Micro Technologies Incorporated', '8/F East Tower, Philippine Stock Exchange Ortigas Center, Pasig City 1605 ', 'Allyxon Cua', 'CEO', 'Company-based'),
...
(56, 'Department of Social Welfare and Development - CAR', '#40 North Drive, Baguio City', 'Bonafe Ramos-Boado', 'Training Specialist 1', 'Company-based'),
(57, 'Commission on Elections ', 'Gov. Pack Road, Baguio City', 'Atty. John Paul A. Martin', 'Election Officer', 'Company-based'),
(58, 'Advanced World Solutions Inc.', 'Unit 3B 3/F Multinational Bancorp Center, 6805 Ayala Avenue, Makati City', 'null', 'null', 'Company-based'),
(59, 'Cambridge University Press', '2/F, 357 Sen. Gil J. Puyat Ave, Makati, 1200 Metro Manila', 'Mr. Ronaldo Manalac', 'Company Head', 'Company-based'),
(60, 'PLDT - Mandaluyong', 'Boni Ave., Barangka, Mandaluyong, Metro Manila', 'null', 'null', 'Company-based'),
(61, 'Camp John Hay Golf Club', 'Camp John Hay, Loakan Rd, Baguio', 'null', 'null', 'Company-based'),
(62, 'Zameco II', 'National Highway, Castillejos, 2208 Zambales', 'Engr. Alvin M. Farrales', 'General Manager', 'Company-based'),
(63, 'Texas Instruments', 'PEZA Loakan, Baguio City 2600', 'Manie Mendoza', 'Recuritment Manager', 'Company-based'),
(64, 'Bureau of Local Government Finance', '#75 Ferguson Road, Baguio City', 'Ma. Florizelda A. Enriquez, CESE', 'Regional Director', 'Company-based');
