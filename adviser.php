                    ...
                    <div class="col-md-12">
                        ...
                        <div class="collapse navbar-collapse navbar-right borderXwidth" id="mynavbar">
                            <ul class="nav navbar-nav ">
                                ...
                                <li class="active"><a href="adviser.php"><span class="fa fa-address-book space"></span>Advisers</a></li>
                            ...
                            while ($row2 = mysqli_fetch_assoc($con1)) {
                                    ...
                                    <td class="text-center">
                                        <a href="profileadviser.php?ad_id='.$row['ad_id'].'" title="Edit Data" class="btn btn-primary btn-sm">
                                            <i class="fa fa-info-circle space" aria-hidden="true"></i> <span>View Advisees</span>
                                        </a>
