		...
		<section class="cta">
			...
			<form class="form-horizontal margin-top margin-bottom" action="" method="post">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label addFont">ID Number</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label addFont">First Name</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label addFont">Last Name</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label addFont">Course & Year</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label addFont">Email</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label addFont">Mobile Number</label>
						<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label addFont">Date Started</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label addFont">Company Name</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label addFont">Requirement</label>
					<div class="col-sm-8">
						<?php
						...
						echo  "<input type='checkbox' name='evaluation' value='yes'><span class='space'></span>Practicum 1 Evaluation </span> <br>";
						echo  "<input type='checkbox' name='endorsement' value='yes'><span class='space'></span>Letter of Endorsement <br>" ;
						echo  "<input type='checkbox' name='waiver' value='yes'><span class='space'></span>OJT Waiver <br>";
