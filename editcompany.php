  ...
  <body>
    ...
    <section class="section-padding">
        <div class="container-fluid">
            ...
            if(isset($_POST['save'])){
                $coname          = mysqli_real_escape_string($_POST['coname'])
                $coaddress           = mysqli_real_escape_string($_POST['coaddress']);
                $company_head        = mysqli_real_escape_string($_POST['company_head']);
